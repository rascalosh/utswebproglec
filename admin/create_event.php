...
<body class="font-[Poppins] min-h-screen bg-gradient-to-t from-[#fbc2eb] to-[#a6c1ee] flex flex-col">
    <header class="bg-[#FFE1FF] py-3 mb-10">
        <nav class="flex justify-between items-center w-[92%] mx-auto">
            ...
            <div class="nav-links duration-500 md:static absolute bg-[#FFE1FF] md:min-h-fit min-h-[60vh] left-0 top-[-100%] md:w-auto w-full flex items-center px-5">
                <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8">
                    <li><a class="text-gray-700 hover:text-pink-900 transition duration-100 ease-in-out" href="indexadmin.php">Dashboard</a></li>
                    <li><a class="text-gray-700 hover:text-pink-900 transition duration-100 ease-in-out" href="create_event.php">Create Event</a></li>
                    <li><a class="text-gray-700 hover:text-pink-900 transition duration-100 ease-in-out" href="user_management.php">Manage Users</a></li>
                </ul>
            </div>
    ...
    <footer class="bg-[#FFE1FF] text-gray-700 py-6 mt-10">
